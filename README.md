...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/tylerting/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/tylerting/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/tylerting/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/tylerting/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/tylerting/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/tylerting/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |        501.12s                   |     60.81s                      | 
| `pg_normalized_batch`  |        174.33s                   |     16.42s                      | 
| `pg_denormalized`      |        18.84s                   |      3.71s                     | 
